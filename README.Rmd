...
Alternatively, you can use create a remote R session to complete the tutorial by launching binder:  [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/mahendra-mariadassou/L1fdvGenetics/master)
...
If you have an error (occurs on Windows, with R 4.0.0), you can try the following command:
```{r, eval =FALSE}
