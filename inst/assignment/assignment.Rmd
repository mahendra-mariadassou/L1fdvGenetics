...
data("hw_data")      ## Homework data: geno/phenotypes of the F1 mice
...
```{r}
rbind(head(genetic_map, 2), tail(genetic_map, 2))
## Nb markers
...
**Instructions:** How would you adapt the analytic strategy to account for diploidy?  
